    ...
    const handleSubmit = async (event) => {
      ...
      if (Object.keys(errors).length > 0) {
        setFormDataError(errors);
          ...
          try {
            const response = await instance.post('api/auth/login-professeur', {
            ...
            if (response.status === 200) {
              ...
              localStorage.setItem("tokkken", token);
              history('/espace-enseignant'); // Utilisez 'push' au lieu de 'history' pour rediriger
          ...
          <div className="body bg-body">
              <div className="container d-flex justify-content-center align-items-center min-vh-100">
                  <div className="row border rounded-5 p-3 bg-white  box-area">
                      {/* <div className="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style={{ backgroundImage: `url(${profL})`, backgroundSize: 'cover' }}> */}
                      <div className="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                          <small className="text-wrap text-center" style={{ width: 30, fontFamily: 'Courier New, Courier, monospace' }}>Espace Enseignant</small>
                      {/* <div className="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"> */}
                          <div className="featured-image">
                              <img src={profL} alt='' className="img-fluid" style={{ width: 420 }} />
                          </div>
