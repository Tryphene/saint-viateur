...
const Accueil = () => {
    ...
    useEffect(() => {
        const fetchData = () => {
            instance.get(`cours/cours-is-actif-professeur/${professeur.id}`, {
                params: {
                    status: 'En cours',
                    isActif: true
              }
        ...
        const fetchDataAllCours = () => {
          instance.get(`cours/all-cours-by-professeur/${professeur.id}`)
              .then(response => {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        const afficheSalaire = () => {
            instance.get(`professeur/find-salaire/${professeur.id}`)
                  .then(response => {
  ...
  return (
      <>
          <Row className="mt-5">
              ...
              <Col xs={12} sm={12} md={4} lg={4}>
                  <div className="d-flex justify-content-evenly p-2 rounded-3" style={{ color: "black", with: "auto", backgroundColor: "pink" }}>
                      <div className="p-3" style={{ with: "auto", borderRadius: "100%", backgroundColor: "white" }}>
                            ...
                            <Col xs={12} sm={12} md={5} lg={5}>
                                <div className="">
                                    <p className="my-0 py-0 fw-semibold" style={{ fontSize: 22, letterSpacing: 0, fontWeight: 400, color: 'black' }}>Salaire</p>
                                     <p className='my-0 text-muted' style={{ marginTop: 12, fontSize: 13 }}>Mon salaire</p>
                                </div>
                                <div className="">
                          ...
                          <Container className='mt-2'>
                              <Row className='p-4'>
                                  {cours.length > 0 ?
                                      ...
                                      :
                                      (
                                          <p style={{fontWeight: 300}}>Vous n'avez pas de cours en cours pour le moment</p>
                                      )
                                  }
                              </Row>
                          </Container>
          ...
          <div className="my-5 rounded-4 p-3" style={{ background: "white" }}>
              ...
              <div className="pb-3 px-4">
                  {cours.length > 0 ?
                      (
                          <CahierPresence profInterface={true} heureProf={false} app={false} entite={`professeur`} id={professeur.id} nomCours={nomCours} proffid={professeur.id} />
                      )
                      :
                      (
                          <p style={{fontWeight: 300}}>Vous n'avez pas de cours en cours pour le moment</p>
